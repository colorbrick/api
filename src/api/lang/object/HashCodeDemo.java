...
ex) 트위터에서 해시태그를 게시글에 첨부하는 것.
	 동일한 해시태그가 첨부된 게시글은 동일한 해시태그(주소값) 을 참조하게되어
...
public class HashCodeDemo {
	public static void main(String[] args) {
		...
		String abcd2 = "abcd";
		System.out.println("abcd의 해시태그 : " + abcd.hashCode());
		System.out.println("abcd2의 해시태그 : " + abcd2.hashCode());
		 ...
		 * 모든 객체 중, 유일하게 String 만 이 같은 특징을 가진다.
		 * */
	}
