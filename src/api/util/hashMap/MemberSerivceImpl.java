...
public class MemberSerivceImpl implements MemberService {
	...
	public void join(String id, String password, String name, int age,
		...
		// 키와 밸류 ㅍ턴에서 밸류값을 String 으로 통일시키려고
	...
	public void login(String id, String password) {
		...
		if(map.get("id").equals(id) && map.get("password").equals(password)){
			...
			System.out.println(" 입력하신 ID는 존재하지 않고나, 일치하지 않습니다. 다시 입력해 주세요.");
		} else {
	...
	// 출력문 예시
	// 입력하신 ID는 존재하지 않고나, 일치하지 않습니다. 다시 입력해 주세요.
	// 비번이 다릅니다. 다시 입력하세요.
	// 환영합니다. 서울시에 사는 20세 홍길동 님..
