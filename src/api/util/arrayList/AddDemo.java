...
public class AddDemo {
	public static void main(String[] args) {
		 ...
		 * 3가지 선택사항이 뜬다.
		 * 그 중에서 두번째 with Iterator 를 선택한다.
		 * */
		...
		// 패턴입니다.
		list2.addAll(lists); // 서울, 부산, 대구 를 복사해서 집어넣은 상태
		/*
		 *  출력 4. 확장 for 문
		...
		while (it4.hasNext()) {
			...
			// 참고로 printf에서
			// 10진수 숫자값으은 %d 로 시작하는 demical의 약자 입니다.
		}
		System.out.println();
	}
